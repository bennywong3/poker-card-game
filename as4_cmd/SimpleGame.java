	...
	class startgame implements ActionListener { 
		...
		public void actionPerformed(ActionEvent event) {
			...
			if (bet < 0) {
					...
					deck.clear();
					label_Image4.setIcon(new ImageIcon("Images//card_"+order.get(3)+".gif"));
					label_Image5.setIcon(new ImageIcon("Images//card_"+order.get(4)+".gif"));
					label_Image6.setIcon(new ImageIcon("Images//card_"+order.get(5)+".gif"));
					...
					btn_rpcard1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if (rp>=2 || finish) {
								...
								label_Image4.setIcon(new ImageIcon("Images//card_"+order.get(6)+".gif"));
					...
					btn_rpcard2.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if (rp>=2 || finish) {
								...
								label_Image5.setIcon(new ImageIcon("Images//card_"+order.get(6)+".gif"));
					...
					btn_rpcard3.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if (rp>=2 || finish) {
								...
								label_Image6.setIcon(new ImageIcon("Images//card_"+order.get(6)+".gif"));
					...
					btn_result.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							finish=true;
							label_Image1.setIcon(new ImageIcon("Images//card_"+order.get(0)+".gif"));
							label_Image2.setIcon(new ImageIcon("Images//card_"+order.get(1)+".gif"));
							label_Image3.setIcon(new ImageIcon("Images//card_"+order.get(2)+".gif"));
							for (int i = 0; i < 3; i++) {
